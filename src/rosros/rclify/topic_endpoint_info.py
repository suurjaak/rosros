...
Partially modified copy from ROS2 `rclpy.topic_endpoint_info`,
at https://github.com/ros2/rclpy (`rclpy/rclpy/topic_endpoint_info.py`),
...
------------------------------------------------------------------------------
"""
## @namespace rosros.rclify.topic_endpoint_info
...
from . qos import QoSPresetProfiles, QoSProfile
